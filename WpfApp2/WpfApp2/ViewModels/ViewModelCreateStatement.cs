        ...
        public ViewModelCreateStatement(NavigationController controller) : base(controller)
        {
            ...
            ToCreateStatementCommand = new DelegateCommand(
                () =>
                {
                    ...
                    //Data.Complete();
                    int togle = 0;
                    string fileName = System.IO.Path.GetTempPath() + Guid.NewGuid().ToString() + ".docx";
                   // string fileName = "Выписка_заготовка.docx";
                    ...
                    //    {
                    //        if(togle == 0)
                    //        File.WriteAllBytes(@"Выписка_заготовка.docx", bte);
                    //        else
                    //        File.WriteAllBytes(@"Выписка_заготовка" + togle + ".docx", bte);
                    ...
                    //    {
                    //        togle += 1;
                    //        fileName = "Выписка_заготовка" + togle + ".docx";
                    //    }
                    //}

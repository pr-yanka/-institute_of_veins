...
{
    public class PreparateHatePanelViewModel : ViewModelBase, INotifyPropertyChanged
    {
        ...
        public PreparateHatePanelViewModel(ViewModelBase parentVM) : base(parentVM.Controller)
        {
            ParentVM = parentVM;

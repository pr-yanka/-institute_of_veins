...
{
    public class PDSVVayTypePanelViewModel : ViewModelBase, INotifyPropertyChanged
    {
        ...
        public PDSVVayTypePanelViewModel(ViewModelBase parentVM) : base(parentVM.Controller)
        {
            ParentVM = parentVM;

...
{
    public class AlergicAnevrizmPanelViewModel : ViewModelBase, INotifyPropertyChanged
    {
        ...
        public AlergicAnevrizmPanelViewModel(ViewModelBase parentVM) : base(parentVM.Controller)
        {
            ParentVM = parentVM;

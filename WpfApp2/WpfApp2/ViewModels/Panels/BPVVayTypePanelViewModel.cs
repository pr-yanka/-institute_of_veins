...
{
    public class BPVVayTypePanelViewModel : ViewModelBase, INotifyPropertyChanged
    {
        ...
        public BPVVayTypePanelViewModel(ViewModelBase parentVM) : base(parentVM.Controller)
        {
            ParentVM = parentVM;
        ...
        public BPVHipWay GetPanelType()
        {
            var newType = new BPVHipWay();

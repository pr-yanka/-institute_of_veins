...
{
    public class AnalizePanelViewModel : ViewModelBase, INotifyPropertyChanged
    {
        ...
        public AnalizePanelViewModel(ViewModelBase parentVM) : base(parentVM.Controller)
        {
            ParentVM = parentVM;
        ...
        public AnalizeType GetPanelType()
        {
            var newType = new AnalizeType();

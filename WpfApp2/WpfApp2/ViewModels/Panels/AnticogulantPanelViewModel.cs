...
{
    public class AnticogulantPanelViewModel : ViewModelBase, INotifyPropertyChanged
    {
        ...
        public AnticogulantPanelViewModel(ViewModelBase parentVM) : base(parentVM.Controller)
        {
            ParentVM = parentVM;
        ...
        public Anticogulants GetPanelType()
        {
